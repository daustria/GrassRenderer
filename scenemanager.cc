...
{
    // Will not bother deleting this in the deconstructor. Program is 'one and done'.
...
void SceneManager::init_grass()
{
    ...
    for (int i = 0; i < NUM_BLADES; ++i) {
        ...
        // position /= 20.0f; // Put the blades closer together. Maybe I can program this better
